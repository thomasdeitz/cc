const PressKit = {
    ...
    <Section heading="Video" alignment="center">
         <div class="photo-grid">
            ...
            <iframe style="border-radius:12px; margin:auto; aspect-ratio: 16 / 9;" width="100%" src="https://www.youtube.com/embed/NhFrOGuOjBM?si=8On0wMtTHPDlp_ho" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <iframe style="border-radius:12px; margin:auto;aspect-ratio: 16 / 9;" width="100%" src="https://www.youtube.com/embed/JSaMtP3Mo4M?si=I_tnzRahavRH52PT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <iframe style="border-radius:12px; margin:auto;aspect-ratio: 16 / 9;" width="100%" src="https://www.youtube.com/embed/r0LlDn72GXs?si=4iRVOO7iRIYMoizP" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
